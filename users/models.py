...
from django.contrib.auth.base_user import AbstractBaseUser #ゼロから構築するときに必要
...
class User(AbstractBaseUser, PermissionsMixin): #set
    """カスタムユーザーモデル"""
    initial_point = 50000
    email = models.EmailField("メールアドレス", unique=True) #データのかぶりがないようにする
